package org.example.concurrency.task3;
...
public class DeadlockExample {
    ...
    public void execute() {
        ...
        Thread thread2 = new Thread(() -> {
            for (int i = 0; i < 5; i++) {
                /**
                 * ТУТ ЗАМЕНА МЕСТАМИ lockA и lockB
                 * deadlock из-за несогласованного порядка захвата блокировок lockA и lockB в разных потоках.
                 */
